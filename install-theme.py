...
def hook_prompt():
    ...
    line = (
        'source ~/.config/fish/ELMY0711-prompt.fish'
    )
    ...
    if line not in text:
        ...
        text += "\n"
        text += "# ELMY0711 PROMPT\n"
        text += line + "\n"

        CONFIG.write_text(text)

        print("✓ Hook prompt ditambahkan")
    else:
        print("✓ Hook prompt sudah ada")
...
def apply_theme(num):
    ...
    print("✓ config.fish tidak ditimpa")
    print("✓ Command: tema")
