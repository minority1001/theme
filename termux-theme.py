...
"7":("Cyberpunk","JetBrainsMono","regular","#090014","#00ffff",
["#120024","#ff0055","#00ff9c","#ffe600","#00aaff","#ff00ff",
"#00ffff","#d8d8d8","#3b0057","#ff3366","#33ffbb","#ffff33",
...
["#343f44","#e67e80","#a7c080","#dbbc7f","#7fbbb3","#d699b6",
"#83c092","#d3c6aa","#475258","#e67e80","#a7c080","#dbbc7f",
"#7fbbb3","#d699b6","#83c092","#e9e8d2"]),
"10":("Monokai","Mononoki","regular","#272822","#f8f8f2",
["#272822","#f92672","#a6e22e","#f4bf75","#66d9ef","#ae81ff",
...
def tema_cmd():
    x=B/"tema"
    x.write_text(f'#!/data/data/com.termux/files/usr/bin/bash\nexec python "$HOME/termux-theme.py" "$@"\n')
    x.chmod(0o755)
...
def main():
    setup()
    if not sys.stdin.isatty() or "--install" in sys.argv: install()
    else: menu()
